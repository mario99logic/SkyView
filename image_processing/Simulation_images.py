...
def preprocess_image(image, threshold=240):
...
image_paths = ['/Users/mariorohana/Desktop/1.png', '/Users/mariorohana/Desktop/2.png',
               '/Users/mariorohana/Desktop/3.png']

moon_locations = process_multiple_images(image_paths)

print(moon_locations)
